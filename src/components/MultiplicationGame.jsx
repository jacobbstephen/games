...
const MultiplicationGame = () => {
  ...
  useEffect(() => {
    if (gameState === 'playing' && problems.length > 0) {
      const currentProblem = problems[currentQuestion];
      setTimeout(() => {
        speak(`Question ${currentQuestion + 1}: What is ${currentProblem.question.replace('×', 'times')}?`);
      }, 100);
    }
      ...
      <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-4 font-mono">
        <div className="text-center max-w-2xl">
          ...
          <button
            ...
            className="bg-teal-600 hover:bg-teal-700 text-white px-6 py-3 rounded-lg text-xl font-semibold flex items-center gap-2 mx-auto mb-8 focus:outline-none focus:ring-4 focus:ring-teal-300"
